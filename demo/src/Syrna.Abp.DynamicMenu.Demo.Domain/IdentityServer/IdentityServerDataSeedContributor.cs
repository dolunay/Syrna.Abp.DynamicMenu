...
namespace Syrna.Abp.DynamicMenu.Demo.IdentityServer
{
    public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        {
            await CreateApiScopeAsync("DynamicMenu");
        }
        ...
        private async Task CreateApiResourcesAsync()
        {
            ...
            await CreateApiResourceAsync("DynamicMenu", commonApiUserClaims, apiApiResourceSecrets);
        }
        ...
        private async Task CreateClientsAsync()
        {
            ...
            if (!webClientId.IsNullOrWhiteSpace())
            {
                ...
                await CreateClientAsync(
                    ...
                    secret: (configurationSection["DynamicMenu_Web:ClientSecret"] ?? "1q2w3e*").Sha256(),
            ...
            {
                var webClientRootUrl = configurationSection["DynamicMenu_App:RootUrl"]?.TrimEnd('/');

                await CreateClientAsync(
                    name: consoleAndAngularClientId,
                    scopes: commonScopes,
                    grantTypes: new[] { "password", "client_credentials", "authorization_code" },
                    secret: (configurationSection["DynamicMenu_App:ClientSecret"] ?? "1q2w3e*").Sha256(),
            ...
            if (!blazorClientId.IsNullOrWhiteSpace())
            {
                ...
                await CreateClientAsync(
                    ...
                    secret: configurationSection["DynamicMenu_Blazor:ClientSecret"]?.Sha256(),
                    requireClientSecret: false,
            ...
            if (!swaggerClientId.IsNullOrWhiteSpace())
            {
                ...
                await CreateClientAsync(
                    ...
                    scopes: commonScopes,
                    grantTypes: new[] { "authorization_code" },
                    secret: configurationSection["DynamicMenu_Swagger:ClientSecret"]?.Sha256(),
                    requireClientSecret: false,
